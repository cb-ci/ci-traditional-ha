...
- **HAProxy**: Routes traffic to `oc.ha` (CJOC) or `controller.ha` (Controllers). It implements sticky sessions via the `cloudbees_sticky` cookie.
...
| **Check HA Status** | Access `http://controller.ha/manage/highAvailability` |
