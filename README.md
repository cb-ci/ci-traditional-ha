...
2. Trigger the [`SSH Test Pipeline`](https://controller.ha/job/testpipeline/) on the controller (pre-created already by [controller casc items](casc/controller/items.yaml)).
